...
par(mfrow = c(1, 4))
for(i in c(23:25, 29)){
  plot(log(paintings_train_new[,i] + 0.1), paintings_train_new[,10], xlab = colnames(paintings_train_new)[i], ylab = "logprice", cex.axis = 2, cex.lab = 2)
}
```
...
```{r BIC with interaction, echo=TRUE}
