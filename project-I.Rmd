...
### eda version 1
```{r, fig.height = 32, fig.width = 24, fig.cap = "Scatter plots of predictors versus logprice"}
# scatterplot
par(mfrow = c(8, 6))
...
# scatterplot
par(mfrow = c(6, 4))
for(i in c(3:9, 15:16, 19:21, 23:25, 28:29, 31:37)){
  plot(paintings_train_new[,i], paintings_train_new[,10], xlab = colnames(paintings_train_new)[i], ylab = "logprice", cex.axis = 2.5, cex.lab = 2.5)
}
```

```{r, fig.height = 24, fig.width = 16, fig.align = "center", fig.cap = "Scatter plots of predictors versus logprice"}
# scatterplot
par(mfrow = c(6, 4))
for(i in 38:59){
  plot(paintings_train_new[,i], paintings_train_new[,10], xlab = colnames(paintings_train_new)[i], ylab = "logprice", cex.axis = 2.5, cex.lab = 2.5)
