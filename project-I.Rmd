...
From the result of random forest, we can choose $16$ variables.

```{r, echo = TRUE, cache = TRUE}
# full model
model_full <- lm(logprice ~ (position + dealer + year + origin_author + origin_cat + winningbiddertype + endbuyer + type_intermed + Surface + mat + paired + finished + lrgfont + n_author + n_bidder + ratio)^2, data = paintings_train_new)
