...
# clean position
paintings_test_new <- paintings_test_new[-which(paintings_test_new$position > 1),]
...
# delete repeating data
paintings_test_new <- unique(paintings_test_new)
...
# clean Surface
paintings_test_new <- paintings_test_new[-which(paintings_test_new$Surface == 0),]
