...
paintings_test_new[which(paintings_test_new$Diam_in != 0), 60] <- 1

# replace blank space and NA of categorical variables with n/a
paintings_test_new[, c(4, 6:9, 12:22, 25, 27:28, 30:32, 34:59)] <- as.data.frame(sapply(paintings_test_new[, c(4, 6:9, 12:22, 25, 27:28, 30:32, 34:59)], function(x) ifelse(x == "" | x == "-", "n/a", x)))
...
```{r}
# prediction
pred_gam <- predict.gam(model_gam, paintings_test_new, type="response", se.fit = TRUE)
