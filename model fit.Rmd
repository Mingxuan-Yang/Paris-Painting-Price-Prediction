...
```{r}
# model
model_rf <- randomForest(logprice ~ year + log_Surface + dealer + lrgfont + endbuyer + origin_author + finished + winningbiddertype + position + type_intermed + mat + diff_origin + authorstyle + prevcoll, data = paintings_train_new, mtry = 4, importance = TRUE)
